...
--image-dir data/wholebody34/obj_train_data \
--img-size ${SIZE} \
--exp-name ultratinyod_res_anc${ANCHOR}_w${CNNWIDTH}_${SIZE}_lr0.0007 \
--batch-size 64 \
--epochs 300 \
--lr 0.0007 \
--weight-decay 0.0001 \
...
--image-dir data/wholebody34/obj_train_data \
--img-size ${SIZE} \
--exp-name ultratinyod_res_anc${ANCHOR}_w${CNNWIDTH}_${SIZE}_lr0.0005 \
--batch-size 64 \
--epochs 300 \
--lr 0.0005 \
--weight-decay 0.0001 \
...
--image-dir data/wholebody34/obj_train_data \
--img-size ${SIZE} \
--exp-name ultratinyod_res_anc${ANCHOR}_w${CNNWIDTH}_${SIZE}_lr0.0003 \
--batch-size 64 \
--epochs 300 \
--lr 0.0003 \
--weight-decay 0.0001 \

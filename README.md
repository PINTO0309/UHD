...
- `opencv_inter_nearest` + Optimized for OpenCV downsampling + Suitable for quantization
  ...
  |Var|Par|FLOPs|@0.5|latency|size|static|w/o post|dynamic|w/o post|
  |:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|

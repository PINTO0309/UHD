...
| `--utod-quant-arch` | UltraTinyOD quantization-robust architecture mode: `0` off, `1` box stage2 residual gain, `2` box stage2 low-rank pw, `3` split `box_out` (`xy/wh`), `4` box activation clip (ReLU6), `5` gated large-object fusion, `6` (`1+5`), `7` (`1+3`), `8` (`2+3`). (`1`/`2`/`6`/`7`/`8` are designed for `--use-iou-aware-head`, `5`/`6` for `--utod-large-obj-branch`) | `0` |
